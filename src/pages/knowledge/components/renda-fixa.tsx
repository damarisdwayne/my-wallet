  ...
  <div className="space-y-8">
    ...
    <Section title="CDI, SELIC, IPCA e Poupança — Os Índices que Regem Tudo">
      <div className="grid gap-3 sm:grid-cols-2 sm:grid-rows-2">
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Taxa básica de juros da economia brasileira, definida pelo COPOM (Banco Central) a cada 45 dias. É a referência de custo de dinheiro no Brasil. Todos os outros indexadores giram em torno dela.</p>
        </Card>
        <Card className="p-4 space-y-2">
          <p className="font-semibold text-sm text-foreground">CDI</p>
          <p className="text-sm text-muted-foreground">Certificado de Depósito Interbancário — taxa que bancos cobram entre si para empréstimos de curtíssimo prazo. Fica ~0,1% abaixo da SELIC. É o índice de referência dos investimentos de renda fixa. "100% do CDI" ≈ SELIC − 0,1%.</p>
        </Card>
        <Card className="p-4 space-y-2">
          <p className="font-semibold text-sm text-foreground">IPCA</p>
          <p className="text-sm text-muted-foreground">Índice Nacional de Preços ao Consumidor Amplo — mede a inflação oficial do Brasil. Calculado pelo IBGE mensalmente com base numa cesta de produtos e serviços consumidos pelas famílias. Quando um título rende "IPCA + 6%", isso significa inflação do período mais 6% de ganho real. É o índice de referência para proteção do poder de compra.</p>
        </Card>
        <Card className="p-4 space-y-2">
          <p className="font-semibold text-sm text-foreground">Poupança — evite</p>
          <p className="text-sm text-muted-foreground">Quando SELIC {'>'} 8,5% ao ano: rende 0,5% ao mês + TR (quase zero). Quando SELIC ≤ 8,5%: rende 70% da SELIC. Isenta de IR, mas mesmo assim perde para CDB e até para o Tesouro Selic em termos líquidos. Não use como investimento.</p>
        </Card>
      </div>
    </Section>
    ...
    <Section title="Taxa Nominal vs Taxa Real">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          <strong className="text-foreground">Taxa nominal</strong> é o número que aparece no contrato — ex: 12% ao ano. <strong className="text-foreground">Taxa real</strong> é o que você efetivamente ganha acima da inflação. São coisas muito diferentes.
        </p>
        ...
        <div className="grid sm:grid-cols-3 gap-2 text-xs">
          {[
            { cenario: 'Investimento rende 12%, inflação 10%', real: '1,8% real', cor: 'text-yellow-600 dark:text-yellow-400' },
            { cenario: 'Investimento rende 12%, inflação 4%', real: '7,7% real', cor: 'text-green-600 dark:text-green-400' },
            { cenario: 'Investimento rende 6%, inflação 7%', real: '−0,9% real', cor: 'text-destructive' },
          ].map((c) => (
        ...
        <p className="text-xs text-muted-foreground">
          <strong className="text-foreground">Por que importa:</strong> em 2021-22 o Brasil teve inflação de ~10%. Quem tinha dinheiro na poupança (~4% ao ano) estava perdendo poder de compra mesmo "ganhando". Só há enriquecimento real quando a taxa nominal supera consistentemente a inflação.
        </p>
      </Card>
    </Section>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Você sabe exatamente quanto vai receber. Bom quando a Selic está alta e tende a cair — você garante a taxa atual por mais tempo. Ruim se a inflação disparar acima do contratado.
          </p>
        </Card>
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Acompanha o CDI (que segue a Selic). Ideal para reserva de emergência e quando há incerteza sobre o futuro dos juros. Sempre rendendo próximo da taxa básica.
          </p>
        </Card>
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Garante 6% de taxa <em>real</em> acima da inflação — independente de quanto o IPCA suba. Se a inflação for 5%, você recebe 11%. Se for 10%, recebe 16%. Ideal para preservar poder de compra no longo prazo.
          </p>
        </Card>
      </div>
    </Section>
    ...
    <Section title="Marcação a Mercado">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          Títulos prefixados e IPCA+ têm preço que varia diariamente no mercado secundário — isso se chama <strong className="text-foreground">marcação a mercado</strong>. O preço sobe quando as taxas de juros caem, e cai quando as taxas sobem. Se você segurar o título até o vencimento, recebe exatamente a taxa contratada. Se vender antes, recebe o preço de mercado do dia — podendo ganhar mais ou levar prejuízo.
        </p>
        <div className="grid sm:grid-cols-2 gap-3">
          <div className="bg-green-50 dark:bg-green-950/30 rounded p-3">
            <p className="text-sm font-medium text-green-800 dark:text-green-300">Marcação a favor (oportunidade)</p>
            <p className="text-sm text-green-700 dark:text-green-400 mt-1">Se você comprou IPCA+ 7% e o mercado cai para IPCA+ 5%, seu título vale mais. Vender antes do vencimento gera ganho extra além dos juros.</p>
          </div>
          <div className="bg-red-50 dark:bg-red-950/30 rounded p-3">
            <p className="text-sm font-medium text-red-800 dark:text-red-300">Marcação contra (armadilha)</p>
            <p className="text-sm text-red-700 dark:text-red-400 mt-1">Se as taxas subiram, seu título desvalorizou. Vender antes do vencimento garante prejuízo. A solução é simples: não venda antes do vencimento.</p>
          </div>
        </div>
        <p className="text-xs text-muted-foreground">
          <strong className="text-foreground">Tesouro Selic não sofre marcação a mercado</strong> significativa — seu preço sobe linearmente todo dia. Por isso é o ideal para reserva de emergência.
        </p>
      </Card>
    </Section>
    ...
    <Section title="IOF — O Imposto Esquecido">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          Além do IR, existe o <strong className="text-foreground">IOF (Imposto sobre Operações Financeiras)</strong> que incide sobre resgates realizados em menos de 30 dias. É tabelado e regressivo: começa em 96% do rendimento no 1º dia e chega a 0% no 30º dia.
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
          {[
            ...
            <div key={row.dia} className="flex flex-col items-center bg-muted rounded px-3 py-2 gap-1">
        ...
        <p className="text-xs text-muted-foreground">
          <strong className="text-foreground">Na prática:</strong> nunca resgate um investimento de renda fixa antes de 30 dias a menos que seja emergência. O IOF é cobrado sobre o rendimento, não sobre o principal — mas pode zerar completamente o ganho nos primeiros dias.
        </p>
      </Card>
    </Section>
    ...
    <Section title="FGC — Fundo Garantidor de Créditos">
      <Card className="p-4 space-y-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          <strong className="text-foreground">Índice de Basileia:</strong> indicador de saúde financeira dos bancos — quanto maior, mais capital próprio o banco tem para absorver perdas. Acima de 11% é o mínimo exigido pelo BC. Bancos sólidos ficam acima de 14-16%. Antes de investir em CDB de banco médio, consulte o Índice de Basileia da instituição no site do Banco Central (bcb.gov.br).
        </p>
      </Card>
    </Section>
    ...
    <Section title="Fundos de Renda Fixa e Come-Cotas">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          Fundos de RF investem nos mesmos ativos (CDB, Tesouro, Debêntures) que você compraria diretamente, mas cobram taxa de administração e sofrem um mecanismo chamado <strong className="text-foreground">Come-Cotas</strong>: o IR é cobrado antecipadamente em maio e novembro de cada ano, sobre o rendimento acumulado, com alíquota de 15% (fundo longo prazo) ou 20% (curto prazo).
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          O problema: o IR cobrado antecipadamente não fica rendendo para você — é como se o governo "comesse" parte das suas cotas antes do tempo. Isso reduz o efeito dos juros compostos ao longo dos anos.
        </p>
        <div className="grid sm:grid-cols-2 gap-3">
          <div className="bg-red-50 dark:bg-red-950/30 rounded p-3">
            <p className="text-sm font-medium text-red-800 dark:text-red-300">Fundo de RF (Come-Cotas)</p>
            <p className="text-sm text-red-700 dark:text-red-400 mt-1">IR cobrado em maio e novembro. Capital tributado antecipadamente perde poder de composição. Taxa de administração reduz o retorno bruto.</p>
          </div>
          <div className="bg-green-50 dark:bg-green-950/30 rounded p-3">
            <p className="text-sm font-medium text-green-800 dark:text-green-300">CDB direto (sem Come-Cotas)</p>
            <p className="text-sm text-green-700 dark:text-green-400 mt-1">IR só no resgate, com alíquota decrescente até 15% após 2 anos. Todo o capital fica compondo até o vencimento. Mais eficiente no longo prazo.</p>
          </div>
        </div>
        <p className="text-xs text-muted-foreground">
          <strong className="text-foreground">Conclusão prática:</strong> Na maioria dos casos, comprar CDB, LCI ou Tesouro Direto diretamente é mais eficiente que investir por fundos de RF. A exceção pode ser acesso a ativos que não estão disponíveis individualmente para o investidor pessoa física.
        </p>
      </Card>
    </Section>
    ...
    <Section title="Estratégia: Construindo uma Carteira de Renda Fixa">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          <strong className="text-foreground">Reserva de emergência:</strong> Tesouro Selic ou CDB de liquidez diária, equivalente a 6-12 meses de gastos. Não comprometa com prazo fixo. É para imprevistos — não misture com investimento.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          <strong className="text-foreground">Reserva de oportunidade:</strong> diferente da emergência, é dinheiro separado intencionalmente para aproveitar quedas na bolsa. Fica no Tesouro Selic ou CDB líquido aguardando. Quando o mercado cai, você tem munição para comprar ativos bons com desconto.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
