    ...
    <Section title="Hierarquia de Risco e Retorno">
      <div className="space-y-2">
        {[
          ...
          {
            rank: '4',
            label: 'CDB/LCI/LCA de banco médio',
            risk: 'Risco maior + FGC',
            desc: 'Pagam mais justamente pelo maior risco do emissor. O FGC cobre R$ 250k, mas se o banco quebrar, pode demorar para receber. Atenção ao limite do FGC e diversificação.',
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            você garante a taxa atual por mais tempo. Ruim se a inflação disparar.
          </p>
        </Card>
        <Card className="p-4 space-y-2">
        ...
        <Card className="p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Garante rentabilidade real — acima da inflação. Excelente para objetivos de longo prazo
            (aposentadoria, educação dos filhos). Protege o poder de compra independente da
            inflação.
          </p>
        </Card>
      </div>
    ...
    <Section title="Estratégia: Construindo uma Carteira de Renda Fixa">
      <Card className="p-4 space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          de liquidez diária, equivalente a 6-12 meses de gastos. Não comprometa com prazo fixo.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
