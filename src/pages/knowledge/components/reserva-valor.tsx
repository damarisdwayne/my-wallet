  ...
  <div className="space-y-8">
    ...
    <Section title="Bitcoin — Ouro Digital">
      <div className="space-y-3">
        <Card className="p-4 space-y-3">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Bitcoin foi criado em 2009 como um sistema de pagamento descentralizado. Com o tempo,
            passou a ser usado como reserva de valor — especialmente em países com instabilidade
            monetária. Sua oferta é limitada matematicamente a 21 milhões de unidades.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            A narrativa de "ouro digital" tem ganhado força: assim como o ouro, o Bitcoin não tem
