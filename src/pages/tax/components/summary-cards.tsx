  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      <div className="rounded-lg border border-border bg-card p-4">
        ...
        <p className="text-xl font-bold text-success mt-1">{fmt(totalIsento)}</p>
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        ...
        <p className="text-xl font-bold text-foreground mt-1">{fmt(totalExterior)}</p>
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        ...
        <p className="text-xl font-bold text-destructive mt-1">{fmt(totalIrJcp)}</p>
